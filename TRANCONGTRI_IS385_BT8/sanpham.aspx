<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeFile="sanpham.aspx.cs"
  Inherits="TRANCONGTRI_IS385_BT8.sanpham" %>
          ...
          <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("mahang") %>'
            ...
            <div class="card product-card" style="width: 15rem;">
              ...
              <div class="card-body">
                ...
                <asp:LinkButton class="btn btn-primary buy-btn" ID="LinkButton2" runat="server" Text="Thêm vào giỏ hàng"
                  CommandName="add" CommandArgument='<%# Eval("mahang") %>' OnClick="LinkButton2_Click">
                </asp:LinkButton>
              </div>
            </div>
          </asp:LinkButton>
